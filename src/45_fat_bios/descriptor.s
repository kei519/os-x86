...
.cs_bit16:	dq 0x00_0_F_9_A_000000_FFFF	; コードセグメント（16ビットセグメント）
.ds_bit16:	dq 0x00_0_F_9_2_000000_FFFF	; データセグメント（16ビットセグメント）
...
CS_BIT16	equ .cs_bit16 - GDT
DS_BIT16	equ .ds_bit16 - GDT
SS_LDT		equ .ldt       - GDT
...
DS_TASK_4	equ (.ds_task_4 - LDT) | 4 | 3	; タスク4用CSセレクタ
DS_TASK_5	equ (.ds_task_5 - LDT) | 4 | 3	; タスク5用CSセレクタ
DS_TASK_6	equ (.ds_task_6 - LDT) | 4 | 3	; タスク6用CSセレクタ
