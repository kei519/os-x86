...
.s0:	db " E820 Memory Map:", 0x0A, 0x0D, 0
.s1:	db " Base_____________ Length___________ Type____", 0x0A, 0x0D, 0
.s2:	db "<more...>", 0
.s3:	db 0x0D, "         ", 0x0D, 0
.s4:	db " _________________ _________________ ________", 0x0A, 0x0D, 0

put_mem_info:	; put_mem_info(adr)
	; スタックフレームの構築
	push	bp
	mov	bp, sp
